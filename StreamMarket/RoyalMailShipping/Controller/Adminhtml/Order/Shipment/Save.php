...
namespace StreamMarket\RoyalMailShipping\Controller\Adminhtml\Order\Shipment;
...
class Save extends \Magento\Backend\App\Action implements HttpPostActionInterface
{
    ...
    public function __construct(
		...
		\StreamMarket\RoyalMailShipping\Controller\Adminhtml\Mass\Process $procesShipment,
		...
		$this->procesShipment = $procesShipment;
    ...
    public function execute()
    {
		...
		$track = $this->getRequest()->getParam('tracking');
		 $post = $this->getRequest()->getPostValue();
		
		if(isset($data['create_shipping_label'])){
			$packages = $post['packages'];
			$this->procesShipment->createShipment($orderId,$packages);
			echo $orderId;
			exit;
